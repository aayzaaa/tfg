...
class ResNet():
    def __init__(self, game, args):
        ...
        # Neural Net
        self.input_boards = tf.keras.Input(shape=[self.board_d, self.board_x, self.board_y])  # s: batch_size x board_x x board_y
        x_image = Reshape([self.board_x, self.board_d, self.board_y, 1])(self.input_boards)                # batch_size  x board_x x board_y x 1
